...
const I18N = {
  en: {
    ...
    charging: "charging", ed_entity: "Mower", ed_title: "Title (optional)",
  ...
  fr: {
    ...
    charging: "en charge", ed_entity: "Tondeuse", ed_title: "Titre (facultatif)",
  ...
  de: {
    ...
    charging: "lädt", ed_entity: "Mäher", ed_title: "Titel (optional)",
  ...
  es: {
    ...
    charging: "cargando", ed_entity: "Cortacésped", ed_title: "Título (opcional)",
  ...
  it: {
    ...
    charging: "in carica", ed_entity: "Robot tagliaerba", ed_title: "Titolo (facoltativo)",
  ...
  nl: {
    ...
    charging: "laadt op", ed_entity: "Maaier", ed_title: "Titel (optioneel)",
  ...
  pl: {
    ...
    charging: "ładowanie", ed_entity: "Kosiarka", ed_title: "Tytuł (opcjonalnie)",
  ...
  ru: {
    ...
    charging: "заряжается", ed_entity: "Косилка", ed_title: "Заголовок (необязательно)",
  ...
  sv: {
    ...
    charging: "laddar", ed_entity: "Klippare", ed_title: "Titel (valfritt)",
  ...
  no: {
    ...
    charging: "lader", ed_entity: "Klipper", ed_title: "Tittel (valgfritt)",
  ...
  da: {
    ...
    charging: "lader", ed_entity: "Robotplæneklipper", ed_title: "Titel (valgfri)",
...
class WorxVisionCard extends HTMLElement {
  ...
  _header(ents) {
    ...
    if (usable(batteryObj)) {
      ...
      battery = `<div class="battery link${pct < 20 ? " low" : ""}"${moreInfo(ents.battery)}><ha-icon icon="${icon}"></ha-icon>`
        + `<span>${escapeHtml(pct)} %</span>${charging ? `<span class="muted">${escapeHtml(t(hass, "charging"))}</span>` : ""}</div>`;
    }
  ...
  _wifi(ents) {
    ...
    return `<div class="wifi link${bars === 1 ? " weak" : ""}" title="${escapeHtml(t(hass, "wifi"))}"${moreInfo(ents.rssi)}>`
      + `<ha-icon icon="mdi:wifi-strength-${bars}"></ha-icon><span>${escapeHtml(dbm)} dBm</span></div>`;
  }
...
const STYLES = `
  ...
  .wifi.weak ha-icon { color: var(--warning-color, #ff9800); }
  .battery { display: flex; align-items: center; gap: 4px; color: var(--primary-text-color); white-space: nowrap; }
  .battery.low, .battery.low ha-icon { color: var(--error-color, #db4437); }
