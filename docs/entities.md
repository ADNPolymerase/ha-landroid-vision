...
- current zone / resolved from the live RTK position against the map zone polygons when the legacy Worx zone field is empty (Vision/RTK mowers)
- RSSI
...
- party mode active
- pause mode active
- PIN setting supported / API capability, diagnostic
- Vision disable supported / API capability, diagnostic
- random mowing pattern supported / API capability, diagnostic
- map training supported / API capability, diagnostic
- diagnostic upload supported / API capability, diagnostic
