...
- `binary_sensor.<mower>_czujnik_deszczu_aktywny` - rain sensor active.
...
```text
https://github.com/SmartServicePL/worx_vision_cloud_plus_github/blob/main/blueprints/automation/worx_vision_cloud_plus/smart_mowing_schedule.yaml
```
